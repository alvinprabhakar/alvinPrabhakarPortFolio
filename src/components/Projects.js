            ...
            <div className="homepage-color">
                ...
                <div className="Project">
                    ...
                    <div className="project-image">
                            ...
                            <a className="project-link" 
                                href="https://alvinprabhakar-ordermanagement.netlify.app" target="_blank" rel="noopener noreferrer"><BoxArrowUpRight size={25}  />
                            </a>
                ...
                <div className="Project">
                    <div className="project-style">
                            ...
                            <a className="project-link" 
                                href="https://alvinprabhakar-passwordreset.netlify.app" target="_blank" rel="noopener noreferrer"><BoxArrowUpRight size={25}  />
                            </a>
                            </div>
                    </div>
                </div>
                ...
                <div className="Project">
                    <div className="project-style">
                            ...
                            <a className="project-link" 
                                href="http://alvinprabhakar-churchstore.herokuapp.com/" target="_blank" rel="noopener noreferrer"><BoxArrowUpRight size={25}  />
                            </a>
                            </div>
                    </div>
                </div>
